...
PRODUCTION = Path(__file__).parents[1] / "src" / "paretodrive_fusion"
FORBIDDEN_IMPORTS = {
...
def test_fusion_has_no_source_content_executor_network_or_destructive_capability() -> None:
    violations: list[str] = []
    combined = ""
    ...
    assert "CANDIDATE" in combined and "CONFIRMED" in combined
