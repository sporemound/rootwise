...
PRODUCTION = Path(__file__).parents[1] / "src" / "paretodrive_dependency"
FORBIDDEN_IMPORTS = {
...
def test_dependency_has_no_source_content_executor_network_or_destructive_capability() -> None:
    violations: list[str] = []
    combined = ""
    ...
    assert "NOT_EVALUATED" in combined and "missing_evidence_semantics" in combined
