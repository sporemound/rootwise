...
PRODUCTION = Path(__file__).parents[1] / "src" / "paretodrive_history"
FORBIDDEN_IMPORTS = {
...
def test_history_has_no_source_content_executor_network_or_destructive_capability() -> None:
    violations: list[str] = []
    combined = ""
    ...
    assert "rename_inference" in combined and "activity_implies_value" in combined
