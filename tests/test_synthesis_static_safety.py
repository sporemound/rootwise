...
PRODUCTION = Path(__file__).parents[1] / "src" / "paretodrive_synthesis"
FORBIDDEN_IMPORTS = {
...
def test_synthesis_has_no_source_content_executor_network_or_destructive_capability() -> None:
    violations: list[str] = []
    combined = ""
    ...
    assert "composite_score" in combined and "pareto_rank_mutation" in combined
