...
from paretodrive.errors import ParetoDriveError
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="paretodrive-enrich")
    ...
    except (OSError, ParetoDriveError, PermissionError, RuntimeError, ValueError, sqlite3.Error) as exc:
