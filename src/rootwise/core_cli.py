"""Metadata scanner, canonical export, and read-only Core artifact commands."""
...
def parser(prog: str = "rootwise") -> argparse.ArgumentParser:
...
def main(
    argv: Sequence[str] | None = None, *, prog: str = "rootwise"
) -> int:
